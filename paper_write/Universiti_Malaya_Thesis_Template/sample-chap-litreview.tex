...
Residual learning was introduced to make deeper networks easier to optimize \cite{he2016deep}. Instead of asking stacked layers to learn a full mapping $H(x)$, a residual block learns a residual function $F(x)$ and adds the input back to the output:
\begin{equation}
    y = F(x) + x.
\end{equation}
