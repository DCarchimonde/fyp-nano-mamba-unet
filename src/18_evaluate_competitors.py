...
if __name__ == "__main__":
    ...
    evaluate_model(att_unet, r"D:\AI_FYP\models\best_attention_unet.pth", "Attention U-Net (SOTA)")
    ...
    evaluate_model(no_mamba, r"D:\AI_FYP\models\best_ablation_nomamba.pth", "Ablation (无 Mamba 纯卷积)")